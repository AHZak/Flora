...
--
-- Host: localhost:3306
-- Generation Time: May 31, 2021 at 06:56 PM
...
(11, 'admin 1', '22', 'admin@gmail.com', '011c945f30ce2cbafc452f39840f025693339c42', '09360795096', 'admin', 1, '2021-05-31 18:20:22', '2021-05-31 18:20:22');
...
(31, 6773, 14, 'user', 1, 2, 50000, 6000, 'canceled', 11, '2021-05-31 18:25:57', '2021-05-31 18:25:57'),
(32, 3327, 8, 'admin', 1, 2, 83000, 6000, 'done', 10, '2021-05-31 18:28:15', '2021-05-31 18:28:15'),
(33, 6401, 13, 'user', 1, 1, 240000, 0, 'doing', 12, '2021-05-31 18:44:29', '2021-05-31 18:44:29'),
(34, 8194, 8, 'admin', 1, 2, 50000, 6000, 'doing', 10, '2021-05-31 18:46:04', '2021-05-31 18:46:04');
...
(35, 31, 10, 22000, 2, 44000),
(36, 32, 13, 55000, 1, 55000),
(37, 32, 10, 22000, 1, 22000),
(38, 33, 14, 60000, 4, 240000),
(39, 34, 10, 22000, 2, 44000);
...
(10, 'پتوس', '../../flora/upload/images/product-sample.jpg', 'پتوس', 22000, 0, 'رای طراحی دکور داخلی یک گزینه‌ی ایده‌آل است. با انتخاب مناسب گلدان، می‌توان سرعت رشد و قد کشیدن فیکوس لیراتا را تحت کنترل قرار داد. درختچه‌ی فیوکوس نور غیر مستقیم را دوست دارد.                      ', 'visible', 25, 1, '2021-05-14 21:06:55', '2021-05-14 21:06:55'),
...
(1, 'ارسال فوری', 'test1', 'active', 15000),
(2, 'ارسال عادی', 'test2', 'active', 5000);
...
(13, ' 2 arash', 'abedi', '09215919027', NULL, 'arash@gmail.com', 'done', 'expired', '2021-05-31 18:08:44', '2021-05-31 18:08:44'),
(14, 'user', 'testy', '09360795096', NULL, NULL, 'done', 'expired', '2021-05-31 18:24:07', '2021-05-31 18:24:07');
...
(10, '09215919027', 'مازندران، قائم شهر، زیرگذر ترک محله، آزادی، کوی ادیب', 3, 2, '1253657', 'example', 'explain', '2021-05-31 18:14:26', '2021-05-31 18:14:26'),
(11, '09360795096', 'مازندران، قائم شهر، زیرگذر ترک محله، آزادی، آزادی ۶۷', 5, 2, '12569', 'خانه', 'تستی', '2021-05-31 18:25:19', '2021-05-31 18:25:19'),
(12, '09215919027', 'مازندران، قائم شهر، خیابان کارگر', 6, 2, '6897452', 'خونه', 'تست', '2021-05-31 18:42:31', '2021-05-31 18:42:31');
