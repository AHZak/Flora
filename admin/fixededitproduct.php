                      ...
                      ?>
                          ...
                          <?php if($subcategories):?>
                              <?php foreach($subcategories as $subCategory): ?>
                                <option class="subcat" value="<?php echo 'subcat_'.$subCategory['id']; ?>" <?php if($subCategory['id']==$product->getSubCategory()->getSubCategoryId()){ echo 'selected';} ?>>-- <?php echo $subCategory['name'] ?></option>
                              <?php endforeach; ?>
                          <?php endif;?>
