          ...
          <div class="col-md g-3">
            ...
            <form action="">
              <div class="col-12 my-2">
                ...
                <input type="text" class="form-control" id="cat-name" placeholder="گیاهان آپارتمانی ..." value="زیر دسته 2" required="">
              </div>
              <div class="col-12 my-2">
                ...
                <select class="form-select" id="state" required="">
                  ...
                  <option selected>دسته سوم</option>
                </select>
              </div>
              <div class="my-4">
                  <button type="button" class="btn btn-success">ثبت تغییرات</button>
                  <button type="button" class="btn btn-danger mx-2">لغو</button>
              </div>
            </form>
          </div>
