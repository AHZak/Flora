...
<html dir="rtl">
  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shodow">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 py-3 " href="../index.php" target="__blank"><img src="../assets/images/logo/flora-lo.png" height="25px" class="me-3" alt=""> پنل ادمین</a>
